...
<html>
  ...
  <body>
  	...
  	<div id="page-1" class="page" onclick="loadData(1)">1</div>
  	<div id="page-2" class="page" onclick="loadData(2)">2</div>
  	<div id="page-3" class="page" onclick="loadData(3)">3</div>
  	<div id="page-4" class="page" onclick="loadData(4)">4</div>
